...
function multiSignatureExample() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const workflowResult = yield coordinator.startWorkflow({ chainId: src_1.ChainId.STELLAR, transaction }, signers, config);
...
function providerDiscoveryExample() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        discoveries.forEach((discovery) => {
            console.log(`- ${discovery.type}: ${discovery.available ? "Available" : "Not available"}`);
            if (discovery.error) {
                console.log(`  Error: ${discovery.error}`);
            }
        });
        // Get providers for specific chain
        const stellarProviders = yield factory.createProvidersForChain(src_1.ChainId.STELLAR, {
            autoConnect: true,
        });
        console.log(`Found ${stellarProviders.length} providers for Stellar`);
        // Get the best provider for Bitcoin with preferences
        const bestBitcoinProvider = yield factory.getBestProviderForChain(src_1.ChainId.BITCOIN, {
...
function signatureVerificationExample() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const verificationResult = yield src_1.SignatureVerificationUtils.verifySignature({
...
function errorHandlingExample() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        try {
            ...
            console.log("Signing failed as expected:", error instanceof Error ? error.message : error);
            ...
            if (canRecover) {
                // Attempt recovery
                const recoveryResult = yield src_1.signatureProviderErrorRecovery.recover(error, {
...
function sdkBuilderExample() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const sdk = yield (0, src_1.createSDKBuilder)()
            .withDefaultProviders([src_1.ProviderType.MOCK, src_1.ProviderType.LEDGER])
        ...
        const provider = yield src_1.SDKUtils.quickCreateProvider(src_1.ProviderType.MOCK);
...
function registryManagementExample() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const stellarProviders = registry.findProvidersForChain(src_1.ChainId.STELLAR);
        console.log(`Stellar providers: ${stellarProviders.length}`);
        const bitcoinProviders = registry.findProvidersForChain(src_1.ChainId.BITCOIN);
