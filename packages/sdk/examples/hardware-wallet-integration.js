...
class HardwareWalletManager {
    ...
    connectLedger(config) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const ledgerConfig = Object.assign({ connectionTimeout: 15000, devicePollingInterval: 1000, maxConnectionRetries: 5, autoOpenApps: false, enableDebugLogging: true }, config);
            try {
                ...
                console.log(`   Current App: ${this.deviceInfo.currentApp || "Dashboard"}`);
    ...
    getAccountsForChain(chainId, customDerivation) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                const derivationConfig = customDerivation || this.derivationConfigs.get(chainId);
                if (derivationConfig) {
                ...
                const enhancedAccounts = yield Promise.all(accounts.map((account) => __awaiter(this, void 0, void 0, function* () {
                    return ({
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                const signatureRequest = {
                    ...
                    metadata: {
                        hardwareWallet: true,
                        deviceId: (_a = this.deviceInfo) === null || _a === void 0 ? void 0 : _a.deviceId,
    ...
    batchSignTransactions(requests) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            for (let i = 0; i < requests.length; i++) {
                ...
                try {
                    const result = yield this.signTransaction(request.chainId, request.transaction, request.accountAddress);
                    results.push({
                        success: true,
                        signature: result.signature,
                        transactionIndex: i,
                    ...
                    const shouldContinue = yield this.askUserToContinue(i + 1, requests.length);
                    if (!shouldContinue) {
    ...
    waitForAppOpen(chainId, timeoutMs) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            throw new Error(`Timeout waiting for ${this.getRequiredApp(chainId)} app to open`);
        });
    }
        ...
        switch (chainId) {
            case src_1.ChainId.BITCOIN:
                if (!transaction.inputs || !transaction.outputs) {
                    throw new Error("Invalid Bitcoin transaction: missing inputs or outputs");
                }
                break;
            case src_1.ChainId.STELLAR:
                if (!transaction.sourceAccount || !transaction.operations) {
                    throw new Error("Invalid Stellar transaction: missing sourceAccount or operations");
                }
                break;
            case src_1.ChainId.STARKNET:
                if (!transaction.contractAddress || !transaction.entrypoint) {
                    throw new Error("Invalid Starknet transaction: missing contractAddress or entrypoint");
                }
                break;
        }
    }
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return new Promise((resolve, reject) => {
                const timer = setTimeout(() => {
                    reject(new Error("Transaction signing timed out - user did not confirm"));
                }, timeout);
    ...
    handleConnectionError(error) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            void _recoveryContext;
            void error;
            const instructions = src_1.signatureProviderErrorRecovery.getRecoveryInstructions(error);
    ...
    handleSigningError(error, chainId) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                const recoveryResult = yield src_1.signatureProviderErrorRecovery.recover(error, _recoveryContext);
                if (recoveryResult.shouldRetry) {
                    console.log(`🔄 Automatic recovery suggests retry after ${recoveryResult.retryAfterMs}ms`);
                }
            }
    ...
    askUserToContinue(currentIndex, totalCount) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            console.log(`❓ Continue with remaining ${totalCount - currentIndex} transactions? (Assuming yes for example)`);
            return true;
        });
    }
}
...
function hardwareWalletExample() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        try {
            ...
            console.log("\n👛 Getting Accounts...");
            // Bitcoin accounts
            const bitcoinAccounts = yield walletManager.getAccountsForChain(src_1.ChainId.BITCOIN);
            ...
            // Stellar accounts
            const stellarAccounts = yield walletManager.getAccountsForChain(src_1.ChainId.STELLAR);
            ...
            const _bitcoinResult = yield walletManager.signTransaction(src_1.ChainId.BITCOIN, bitcoinTx, bitcoinAccounts[0].address);
            void _bitcoinResult;
            ...
            const _stellarResult = yield walletManager.signTransaction(src_1.ChainId.STELLAR, stellarTx, stellarAccounts[0].address);
            void _stellarResult;
            ...
            const batchResults = yield walletManager.batchSignTransactions(batchRequests);
