...
function basicExample() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        // Get next sequence
        const sequenceInfo = yield sequenceManager.getNextSequence(accountId, () => __awaiter(this, void 0, void 0, function* () {
...
function concurrentExample() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const promises = Array.from({ length: 10 }, (_, i) => __awaiter(this, void 0, void 0, function* () {
            try {
                const managed = yield helper.buildManagedTransaction(sourceKeypair.publicKey(), StellarSdk.Account, (account) => {
...
function lifecycleExample() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const sequenceInfo = yield sequenceManager.getNextSequence(accountId, () => __awaiter(this, void 0, void 0, function* () { return "100"; }));
        console.log("1. Got next sequence:", sequenceInfo.next);
        // Reserve sequence
        const transaction = yield sequenceManager.reserveSequence(accountId, sequenceInfo.next, { type: "payment", amount: "100" });
        console.log("2. Reserved sequence:", transaction === null || transaction === void 0 ? void 0 : transaction.sequence);
        // Mark as submitted
        yield sequenceManager.markSubmitted(accountId, sequenceInfo.next, "txhash123");
        ...
        console.log("   Status:", (_a = pending[0]) === null || _a === void 0 ? void 0 : _a.status);
        // Mark as confirmed
...
function errorHandlingExample() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        while (attempt < maxRetries && !success) {
            ...
            try {
                const managed = yield helper.buildManagedTransaction(accountId, StellarSdk.Account, (account) => {
                    return new StellarSdk.TransactionBuilder(account, {
                        fee: StellarSdk.BASE_FEE,
                        networkPassphrase: StellarSdk.Networks.TESTNET,
                    })
...
function monitoringExample() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        for (const accountId of accounts) {
            yield sequenceManager.getNextSequence(accountId, () => __awaiter(this, void 0, void 0, function* () { return "100"; }));
            yield sequenceManager.getNextSequence(accountId, () => __awaiter(this, void 0, void 0, function* () { return "100"; }));
