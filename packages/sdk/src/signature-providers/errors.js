...
exports.SignatureProviderErrorUtils = exports.AllProvidersFailedError = exports.UnsupportedProviderTypeError = exports.ProviderCreationError = exports.InvalidProviderMetadataError = exports.InvalidProviderIdError = exports.InvalidProviderImplementationError = exports.ProviderAlreadyRegisteredError = exports.DeviceLockedError = exports.DeviceBusyError = exports.DeviceNotFoundError = exports.HardwareWalletError = exports.UnsupportedOperationError = exports.UnsupportedChainError = exports.NetworkError = exports.InsufficientFundsError = exports.InvalidTransactionError = exports.SigningError = exports.UnauthorizedError = exports.UserRejectedError = exports.AuthenticationError = exports.ProviderNotFoundError = exports.ConnectionTimeoutError = exports.ConnectionError = exports.SignatureProviderError = void 0;
/**
...
class UnsupportedChainError extends SignatureProviderError {
    constructor(chainId, providerId) {
        super(`Unsupported chain: ${chainId}`, "UNSUPPORTED_CHAIN", providerId, chainId, false);
    }
}
...
class UnsupportedOperationError extends SignatureProviderError {
    constructor(operation, providerId) {
        super(`Unsupported operation: ${operation}`, "UNSUPPORTED_OPERATION", providerId, undefined, false);
    }
}
...
class ProviderAlreadyRegisteredError extends SignatureProviderError {
    constructor(providerId) {
        super(`Provider with ID '${providerId}' is already registered`, "PROVIDER_ALREADY_REGISTERED", providerId, undefined, false);
    }
}
...
class InvalidProviderImplementationError extends SignatureProviderError {
    constructor(providerId, details) {
        super(`Provider ${providerId} ${details}`, "INVALID_PROVIDER_IMPLEMENTATION", providerId, undefined, false);
    }
}
...
class InvalidProviderMetadataError extends SignatureProviderError {
    constructor(providerId, details) {
        super(`Provider ${providerId} ${details}`, "INVALID_PROVIDER_METADATA", providerId, undefined, false);
    }
}
...
class UnsupportedProviderTypeError extends SignatureProviderError {
    constructor(providerType) {
        super(`Unsupported provider type: ${providerType}`, "UNSUPPORTED_PROVIDER_TYPE", undefined, undefined, false);
    }
}
