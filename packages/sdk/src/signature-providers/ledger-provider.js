...
class LedgerSignatureProvider extends interfaces_1.BaseSignatureProvider {
    constructor(config = {}) {
        super("ledger-provider", {
            ...
            version: "1.0.0",
            description: "Ledger hardware wallet integration for secure transaction signing",
    ...
    connect() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                throw new errors_1.ConnectionError(`Failed to connect to Ledger: ${error}`, this.providerId);
            }
        });
    }
    disconnect() {
    ...
    getAccounts(chainId) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (!this.isConnected() || !this.transport) {
                throw new errors_1.ConnectionError("Ledger device not connected", this.providerId);
            }
            ...
            try {
                ...
                if (error instanceof Error && error.message.includes("App not open")) {
                    throw new errors_1.HardwareWalletError(`Please open the ${(_a = this.config.requiredApps) === null || _a === void 0 ? void 0 : _a[chainId]} app on your Ledger device`, this.providerId);
                }
                throw error;
            }
        });
    ...
    signTransaction(request) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                const publicKey = yield this.getPublicKeyForAccount(request.accountAddress, chainId);
                const result = {
                    signature,
                    publicKey,
                ...
                throw new errors_1.SigningError(`Failed to sign transaction: ${error}`, this.providerId, chainId);
            }
        });
    }
    getCapabilities() {
    ...
    isAppOpen(chainId) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const requiredApp = (_a = this.config.requiredApps) === null || _a === void 0 ? void 0 : _a[chainId];
    ...
    getAppInfo() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                throw new errors_1.HardwareWalletError(`Failed to get app info: ${error}`, this.providerId);
            }
        });
    }
    ensureAppOpen(chainId) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (this.config.autoOpenApps) {
                ...
                throw new errors_1.HardwareWalletError(`Please open the ${requiredApp} app on your Ledger device`, this.providerId);
            }
        });
    }
    getAccountsForChain(chainId) {
        return __awaiter(this, void 0, void 0, function* () {
            var _a;
            const derivationPath = (_a = this.config.defaultDerivationPaths) === null || _a === void 0 ? void 0 : _a[chainId];
            if (!derivationPath) {
                throw new errors_1.UnsupportedChainError(chainId, this.providerId);
            }
    ...
    getPublicKey(_derivationPath, _chainId) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                throw new errors_1.HardwareWalletError(`Failed to get public key: ${error}`, this.providerId);
            }
        });
    }
    ...
    getPublicKeyForAccount(_address, chainId) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return this.getPublicKey(((_a = this.config.defaultDerivationPaths) === null || _a === void 0 ? void 0 : _a[chainId]) || "", chainId);
        });
    }
    ...
    signTransactionForChain(request) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                throw new errors_1.SigningError(`Failed to sign ${chainId} transaction: ${error}`, this.providerId, chainId);
            }
        });
    }
    buildSignedTransaction(request, signature) {
        ...
        switch (chainId) {
            case types_1.ChainId.BITCOIN:
                return Object.assign(Object.assign({}, transaction), { signatures: [signature], txid: `ledger_signed_${Date.now()}` });
            case types_1.ChainId.STELLAR:
                return Object.assign(Object.assign({}, transaction), { signatures: [signature], hash: `ledger_hash_${Date.now()}` });
            case types_1.ChainId.STARKNET:
                return Object.assign(Object.assign({}, transaction), { signature: [signature], transaction_hash: `0x${Date.now().toString(16)}` });
            default:
                return {
                    signature,
                };
