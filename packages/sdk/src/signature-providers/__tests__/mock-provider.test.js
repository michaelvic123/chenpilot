...
describe("MockSignatureProvider", () => {
    ...
    describe("Initialization and Configuration", () => {
        ...
        it("should accept custom provider ID and metadata", () => {
            const customProvider = new mock_provider_1.MockSignatureProvider("custom-mock", {
        ...
        it("should accept custom configuration", () => {
            ...
            const customProvider = new mock_provider_1.MockSignatureProvider("test", undefined, config);
    ...
    describe("Connection Management", () => {
        it("should connect successfully", () => __awaiter(void 0, void 0, void 0, function* () {
            ...
            expect((_a = connection.metadata) === null || _a === void 0 ? void 0 : _a.mockProvider).toBe(true);
        }));
        it("should simulate connection delay", () => __awaiter(void 0, void 0, void 0, function* () {
        ...
        it("should fail connection when configured", () => __awaiter(void 0, void 0, void 0, function* () {
            mockProvider.updateConfig({ shouldFailConnection: true });
            yield expect(mockProvider.connect()).rejects.toThrow(errors_1.ConnectionError);
        }));
        it("should fail connection with custom error", () => __awaiter(void 0, void 0, void 0, function* () {
            const customError = new errors_1.ConnectionError("Custom connection error", "mock-provider");
            mockProvider.updateConfig({
                shouldFailConnection: true,
                connectionError: customError,
            });
            yield expect(mockProvider.connect()).rejects.toThrow("Custom connection error");
        }));
        it("should disconnect successfully", () => __awaiter(void 0, void 0, void 0, function* () {
            yield mockProvider.connect();
            expect(mockProvider.isConnected()).toBe(true);
            yield mockProvider.disconnect();
            expect(mockProvider.isConnected()).toBe(false);
        }));
        it("should notify connection state changes", () => __awaiter(void 0, void 0, void 0, function* () {
    ...
    describe("Account Management", () => {
        it("should return default accounts for all chains", () => __awaiter(void 0, void 0, void 0, function* () {
            const bitcoinAccounts = yield mockProvider.getAccounts(types_1.ChainId.BITCOIN);
            const stellarAccounts = yield mockProvider.getAccounts(types_1.ChainId.STELLAR);
            const starknetAccounts = yield mockProvider.getAccounts(types_1.ChainId.STARKNET);
        ...
        it("should return custom accounts when configured", () => __awaiter(void 0, void 0, void 0, function* () {
        ...
        it("should fail getting accounts when configured", () => __awaiter(void 0, void 0, void 0, function* () {
            mockProvider.updateConfig({ shouldFailGetAccounts: true });
            yield expect(mockProvider.getAccounts(types_1.ChainId.STELLAR)).rejects.toThrow(errors_1.SigningError);
        }));
    ...
    describe("Transaction Signing", () => {
        it("should sign Bitcoin transactions", () => __awaiter(void 0, void 0, void 0, function* () {
            var _a, _b;
            ...
            expect((_a = result.metadata) === null || _a === void 0 ? void 0 : _a.mockProvider).toBe(true);
            expect((_b = result.metadata) === null || _b === void 0 ? void 0 : _b.chainId).toBe(types_1.ChainId.BITCOIN);
        }));
        it("should sign Stellar transactions", () => __awaiter(void 0, void 0, void 0, function* () {
            var _a;
            ...
            expect(result.signedTransaction).toHaveProperty("signatures");
            expect((_a = result.metadata) === null || _a === void 0 ? void 0 : _a.chainId).toBe(types_1.ChainId.STELLAR);
        }));
        it("should sign Starknet transactions", () => __awaiter(void 0, void 0, void 0, function* () {
            var _a;
            ...
            expect((_a = result.metadata) === null || _a === void 0 ? void 0 : _a.chainId).toBe(types_1.ChainId.STARKNET);
        }));
        it("should simulate signing delay", () => __awaiter(void 0, void 0, void 0, function* () {
        ...
        it("should fail signing when configured", () => __awaiter(void 0, void 0, void 0, function* () {
            mockProvider.updateConfig({ shouldFailSigning: true });
            yield expect(mockProvider.signTransaction(createBitcoinSigningRequest())).rejects.toThrow(errors_1.SigningError);
        }));
        it("should simulate user rejection", () => __awaiter(void 0, void 0, void 0, function* () {
            mockProvider.updateConfig({ shouldRejectSigning: true });
            yield expect(mockProvider.signTransaction(createBitcoinSigningRequest())).rejects.toThrow(errors_1.UserRejectedError);
        }));
        it("should simulate random user rejection", () => __awaiter(void 0, void 0, void 0, function* () {
            mockProvider.updateConfig({ rejectionRate: 1.0 }); // 100% rejection rate
            yield expect(mockProvider.signTransaction(createBitcoinSigningRequest())).rejects.toThrow(errors_1.UserRejectedError);
        }));
        it("should validate transaction format", () => __awaiter(void 0, void 0, void 0, function* () {
            ...
            yield expect(mockProvider.signTransaction(invalidRequest)).rejects.toThrow(errors_1.InvalidTransactionError);
        }));
        it("should increment signature counter", () => __awaiter(void 0, void 0, void 0, function* () {
            var _a, _b;
            const result1 = yield mockProvider.signTransaction(createBitcoinSigningRequest());
            const result2 = yield mockProvider.signTransaction(createStellarSigningRequest());
            expect((_a = result1.metadata) === null || _a === void 0 ? void 0 : _a.signatureCounter).toBe(1);
            expect((_b = result2.metadata) === null || _b === void 0 ? void 0 : _b.signatureCounter).toBe(2);
        }));
    });
    describe("Message Signing", () => {
        it("should sign messages", () => __awaiter(void 0, void 0, void 0, function* () {
            var _a, _b;
            const result = yield mockProvider.signMessage("Hello, world!", "test-address", types_1.ChainId.STELLAR);
            expect(result.signature).toMatch(/^mock_msg_sig_/);
            expect(result.publicKey).toBeTruthy();
            expect((_a = result.metadata) === null || _a === void 0 ? void 0 : _a.messageSignature).toBe(true);
            expect((_b = result.metadata) === null || _b === void 0 ? void 0 : _b.message).toBe("Hello, world!");
        }));
        it("should fail message signing when configured", () => __awaiter(void 0, void 0, void 0, function* () {
            mockProvider.updateConfig({ shouldFailMessageSigning: true });
            yield expect(mockProvider.signMessage("test", "address", types_1.ChainId.STELLAR)).rejects.toThrow(errors_1.SigningError);
        }));
    });
    describe("Capabilities", () => {
        it("should return default capabilities", () => {
            ...
            expect((_a = capabilities.metadata) === null || _a === void 0 ? void 0 : _a.mockProvider).toBe(true);
        });
    ...
    describe("Network Simulation", () => {
        it("should simulate network latency", () => __awaiter(void 0, void 0, void 0, function* () {
        ...
        it("should simulate network failures", () => __awaiter(void 0, void 0, void 0, function* () {
            mockProvider.updateConfig({ networkFailureRate: 1.0 }); // 100% failure rate
            yield expect(mockProvider.getAccounts(types_1.ChainId.STELLAR)).rejects.toThrow(errors_1.NetworkError);
        }));
        it("should not fail with 0% network failure rate", () => __awaiter(void 0, void 0, void 0, function* () {
            mockProvider.updateConfig({ networkFailureRate: 0.0 });
            yield expect(mockProvider.getAccounts(types_1.ChainId.STELLAR)).resolves.toBeDefined();
        }));
    });
    describe("Error Simulation", () => {
        it("should simulate specific errors", () => {
            const customError = new errors_1.ConnectionError("Custom error", "mock-provider");
            expect(() => mockProvider.simulateError(customError)).toThrow("Custom error");
        });
    });
    describe("Transaction Validation", () => {
        it("should validate Bitcoin transaction structure", () => __awaiter(void 0, void 0, void 0, function* () {
            ...
            yield expect(mockProvider.signTransaction(invalidBitcoinRequest)).rejects.toThrow("Bitcoin transaction must have inputs");
        }));
        it("should validate Stellar transaction structure", () => __awaiter(void 0, void 0, void 0, function* () {
            ...
            yield expect(mockProvider.signTransaction(invalidStellarRequest)).rejects.toThrow("Stellar transaction must have source account");
        }));
        it("should validate Starknet transaction structure", () => __awaiter(void 0, void 0, void 0, function* () {
            ...
            yield expect(mockProvider.signTransaction(invalidStarknetRequest)).rejects.toThrow("Starknet transaction must have contract address");
        }));
    });
    describe("Logging", () => {
        it("should log when enabled", () => __awaiter(void 0, void 0, void 0, function* () {
            const consoleSpy = jest.spyOn(console, "log").mockImplementation();
            mockProvider.updateConfig({ enableLogging: true });
            yield mockProvider.connect();
            expect(consoleSpy).toHaveBeenCalledWith(expect.stringContaining("[MockSignatureProvider:mock-provider]"), expect.anything());
            consoleSpy.mockRestore();
        }));
        it("should not log when disabled", () => __awaiter(void 0, void 0, void 0, function* () {
            const consoleSpy = jest.spyOn(console, "log").mockImplementation();
    ...
    describe("Signature Generation", () => {
        it("should generate unique signatures", () => __awaiter(void 0, void 0, void 0, function* () {
        ...
        it("should generate chain-appropriate signature formats", () => __awaiter(void 0, void 0, void 0, function* () {
            const bitcoinResult = yield mockProvider.signTransaction(createBitcoinSigningRequest());
            const stellarResult = yield mockProvider.signTransaction(createStellarSigningRequest());
            const starknetResult = yield mockProvider.signTransaction(createStarknetSigningRequest());
