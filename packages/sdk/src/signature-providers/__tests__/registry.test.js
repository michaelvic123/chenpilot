...
class MockProvider extends interfaces_1.BaseSignatureProvider {
    constructor(providerId, metadata, supportedChains = [types_1.ChainId.STELLAR]) {
...
describe("SignatureProviderRegistry", () => {
    ...
    describe("Provider Registration", () => {
        ...
        it("should throw error when registering duplicate provider ID", () => {
            registry.register(mockProvider1);
            expect(() => registry.register(mockProvider1)).toThrow("Provider with ID 'provider1' is already registered");
        });
        it("should validate provider implementation during registration", () => {
            const invalidProvider = {};
            expect(() => registry.register(invalidProvider)).toThrow("Provider must have a valid providerId string");
        });
    ...
    describe("Provider Unregistration", () => {
        ...
        it("should throw error when unregistering non-existent provider", () => {
            expect(() => registry.unregister("nonexistent")).toThrow(errors_1.ProviderNotFoundError);
        });
        it("should disconnect provider before unregistering", () => __awaiter(void 0, void 0, void 0, function* () {
    ...
    describe("Provider Retrieval", () => {
        ...
        it("should throw error for non-existent provider", () => {
            expect(() => registry.getProvider("nonexistent")).toThrow(errors_1.ProviderNotFoundError);
        });
    ...
    describe("Chain-Based Provider Discovery", () => {
        ...
        it("should find providers for specific chain", () => {
            ...
            const starknetProviders = registry.findProvidersForChain(types_1.ChainId.STARKNET);
    ...
    describe("Registry Clearing", () => {
        ...
        it("should clear all providers", () => __awaiter(void 0, void 0, void 0, function* () {
            expect(registry.getProviderCount()).toBe(2);
            expect(mockProvider1.isConnected()).toBe(true);
        ...
        it("should notify unregistration callbacks for all providers when clearing", () => __awaiter(void 0, void 0, void 0, function* () {
            const callback = jest.fn();
            registry.onProviderUnregistered(callback);
            registry.clear();
            // Give time for async operations
    ...
    describe("Provider Validation", () => {
        it("should validate provider has required methods", () => {
            ...
            expect(() => registry.register(invalidProvider)).toThrow("Provider invalid missing required method: connect");
        });
        ...
        it("should validate provider metadata structure", () => {
            ...
            expect(() => registry.register(invalidProvider)).toThrow("Provider test metadata must include name, version, and description");
        });
    ...
    describe("Global Registry Instance", () => {
        it("should provide a global registry instance", () => {
            expect(registry_1.signatureProviderRegistry).toBeInstanceOf(registry_1.SignatureProviderRegistry);
        });
        it("should maintain state across imports", () => {
            registry_1.signatureProviderRegistry.register(mockProvider1);
            expect(registry_1.signatureProviderRegistry.hasProvider("provider1")).toBe(true);
            // Clean up
            registry_1.signatureProviderRegistry.unregister("provider1");
        });
    });
    describe("Error Handling", () => {
        it("should handle provider disconnect errors gracefully during unregistration", () => __awaiter(void 0, void 0, void 0, function* () {
        ...
        it("should handle provider disconnect errors gracefully during clear", () => __awaiter(void 0, void 0, void 0, function* () {
            const faultyProvider = new MockProvider("faulty", mockMetadata1);
            faultyProvider.disconnect = jest
                .fn()
                .mockRejectedValue(new Error("Disconnect failed"));
