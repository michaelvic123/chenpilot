...
describe("Error Recovery System", () => {
    describe("ConnectionErrorRecoveryStrategy", () => {
        ...
        it("should handle connection timeout errors", () => __awaiter(void 0, void 0, void 0, function* () {
        ...
        it("should use exponential backoff for timeouts", () => __awaiter(void 0, void 0, void 0, function* () {
            const error = new errors_1.ConnectionTimeoutError("test-provider");
        ...
        it("should cap exponential backoff", () => __awaiter(void 0, void 0, void 0, function* () {
            const error = new errors_1.ConnectionTimeoutError("test-provider");
            const result = yield strategy.recover(error, { retryCount: 10 });
            expect(result.retryAfterMs).toBe(10000); // Capped at 10 seconds
        }));
        it("should handle provider not found errors", () => __awaiter(void 0, void 0, void 0, function* () {
        ...
        it("should provide recovery instructions", () => {
            ...
            const timeoutInstructions = strategy.getRecoveryInstructions(timeoutError);
            const notFoundInstructions = strategy.getRecoveryInstructions(notFoundError);
    ...
    describe("AuthenticationErrorRecoveryStrategy", () => {
        ...
        it("should handle user rejection errors", () => __awaiter(void 0, void 0, void 0, function* () {
            const error = new errors_1.UserRejectedError("test-provider");
            expect(strategy.canRecover(error)).toBe(true);
            const result = yield strategy.recover(error);
            expect(result.success).toBe(false);
            expect(result.shouldRetry).toBe(false);
            expect(result.instructions).toContain("Transaction was cancelled by user.");
        }));
        it("should handle generic authentication errors with retry", () => __awaiter(void 0, void 0, void 0, function* () {
        ...
        it("should stop retrying auth errors after max attempts", () => __awaiter(void 0, void 0, void 0, function* () {
            const error = new errors_1.UnauthorizedError("test-provider");
            const result = yield strategy.recover(error, {
                retryCount: 2,
                maxRetries: 2,
    ...
    describe("HardwareWalletErrorRecoveryStrategy", () => {
        ...
        it("should handle device not found errors", () => __awaiter(void 0, void 0, void 0, function* () {
        ...
        it("should handle device locked errors", () => __awaiter(void 0, void 0, void 0, function* () {
        ...
        it("should handle device busy errors", () => __awaiter(void 0, void 0, void 0, function* () {
        ...
        it("should handle generic hardware wallet errors", () => __awaiter(void 0, void 0, void 0, function* () {
            const error = new errors_1.HardwareWalletError("Generic HW error", "ledger-provider");
            const result = yield strategy.recover(error);
            expect(result.success).toBe(false);
            expect(result.shouldRetry).toBe(true);
    ...
    describe("NetworkErrorRecoveryStrategy", () => {
        ...
        it("should handle network errors with exponential backoff", () => __awaiter(void 0, void 0, void 0, function* () {
            const error = new errors_1.NetworkError("RPC timeout", "provider", types_1.ChainId.STELLAR);
            expect(strategy.canRecover(error)).toBe(true);
        ...
        it("should include jitter in retry timing", () => __awaiter(void 0, void 0, void 0, function* () {
        ...
        it("should cap retry delay", () => __awaiter(void 0, void 0, void 0, function* () {
            const error = new errors_1.NetworkError("Network error", "provider");
            const result = yield strategy.recover(error, { retryCount: 10 });
    ...
    describe("SignatureProviderErrorRecovery", () => {
        ...
        it("should find appropriate strategy for error type", () => __awaiter(void 0, void 0, void 0, function* () {
            ...
            const networkError = new errors_1.NetworkError("Network error", "provider");
            ...
            expect(authResult.instructions).toContain("Transaction was cancelled by user.");
            expect(hardwareResult.instructions).toContain("Hardware wallet is locked.");
            expect(networkResult.instructions).toContain("Network error occurred.");
        }));
        it("should handle errors without specific strategy", () => __awaiter(void 0, void 0, void 0, function* () {
            const genericError = new errors_1.SigningError("Generic signing error", "provider");
            const result = yield recovery.recover(genericError);
            expect(result.success).toBe(false);
            expect(result.instructions).toContain("No specific recovery strategy available.");
        }));
        it("should convert generic errors to SignatureProviderError", () => __awaiter(void 0, void 0, void 0, function* () {
        ...
        it("should handle recovery strategy errors", () => __awaiter(void 0, void 0, void 0, function* () {
            // Create a faulty strategy that throws
            const faultyStrategy = {
                canRecover: () => true,
                recover: () => __awaiter(void 0, void 0, void 0, function* () {
        ...
        it("should provide recovery instructions without attempting recovery", () => {
            ...
            const connectionInstructions = recovery.getRecoveryInstructions(connectionError);
            const unknownInstructions = recovery.getRecoveryInstructions(unknownError);
        ...
        it("should check if errors are recoverable", () => {
            ...
            const nonRecoverableError = new errors_1.ProviderNotFoundError("provider");
        ...
        it("should allow adding and removing custom strategies", () => __awaiter(void 0, void 0, void 0, function* () {
            ...
            const customError = new errors_1.SigningError("custom error", "provider");
            ...
            expect(result2.instructions).toContain("No specific recovery strategy available.");
        }));
        it("should use global recovery instance", () => {
            expect(error_recovery_1.signatureProviderErrorRecovery).toBeInstanceOf(error_recovery_1.SignatureProviderErrorRecovery);
        });
    });
    describe("Error Recovery Context", () => {
        ...
        it("should use context information in recovery", () => __awaiter(void 0, void 0, void 0, function* () {
        ...
        it("should handle missing context gracefully", () => __awaiter(void 0, void 0, void 0, function* () {
            const error = new errors_1.ConnectionTimeoutError("provider");
            const result = yield recovery.recover(error);
