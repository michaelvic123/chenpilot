...
describe("SignatureProvider Interface", () => {
    ...
    describe("Account Management", () => {
        ...
        it("should return accounts for supported chains", () => __awaiter(void 0, void 0, void 0, function* () {
            const stellarAccounts = yield provider.getAccounts(types_1.ChainId.STELLAR);
            expect(stellarAccounts).toEqual(mockAccounts);
            const starknetAccounts = yield provider.getAccounts(types_1.ChainId.STARKNET);
        ...
        it("should throw error for unsupported chains", () => __awaiter(void 0, void 0, void 0, function* () {
            yield expect(provider.getAccounts(types_1.ChainId.BITCOIN)).rejects.toThrow("Unsupported chain: bitcoin");
        }));
    ...
    describe("Error Handling in Callbacks", () => {
        it("should handle errors in connection callbacks gracefully", () => __awaiter(void 0, void 0, void 0, function* () {
