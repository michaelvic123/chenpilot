        ...
        send(cla, ins, _p1, _p2, _data) {
            return __awaiter(this, void 0, void 0, function* () {
                ...
                if (ins === 0x04) {
                    ...
                    return Buffer.concat([
                        Buffer.from("304402201234567890abcdef1234567890abcdef1234567890abcdef1234567890abcdef02201234567890abcdef1234567890abcdef1234567890abcdef1234567890abcdef", "hex"),
                        Buffer.from([0x90, 0x00]),
                    ]);
                }
...
describe("LedgerSignatureProvider", () => {
    ...
    describe("Initialization and Configuration", () => {
        ...
        it("should accept custom configuration", () => {
            ...
            const customProvider = new ledger_provider_1.LedgerSignatureProvider(config);
    ...
    describe("Connection Management", () => {
        it("should connect successfully", () => __awaiter(void 0, void 0, void 0, function* () {
            ...
            expect((_a = connection.metadata) === null || _a === void 0 ? void 0 : _a.deviceInfo).toBeDefined();
            expect((_b = connection.metadata) === null || _b === void 0 ? void 0 : _b.currentApp).toBeDefined();
        }));
        it("should handle device not found error", () => __awaiter(void 0, void 0, void 0, function* () {
            // Mock transport creation to fail
            const originalCreateTransport = ledgerProvider
                .createTransport;
            ledgerProvider.createTransport = jest
                .fn()
                .mockRejectedValue(new Error("No device found"));
            yield expect(ledgerProvider.connect()).rejects.toThrow(errors_1.DeviceNotFoundError);
            // Restore original method
            ledgerProvider.createTransport = originalCreateTransport;
        }));
        it("should handle device locked error", () => __awaiter(void 0, void 0, void 0, function* () {
            const originalCreateTransport = ledgerProvider
                .createTransport;
            ledgerProvider.createTransport = jest
                .fn()
                .mockRejectedValue(new Error("Device is locked"));
            yield expect(ledgerProvider.connect()).rejects.toThrow(errors_1.DeviceLockedError);
            ledgerProvider.createTransport = originalCreateTransport;
        }));
        it("should handle device busy error", () => __awaiter(void 0, void 0, void 0, function* () {
            const originalCreateTransport = ledgerProvider
                .createTransport;
            ledgerProvider.createTransport = jest
                .fn()
                .mockRejectedValue(new Error("Device is busy"));
            yield expect(ledgerProvider.connect()).rejects.toThrow(errors_1.DeviceBusyError);
            ledgerProvider.createTransport = originalCreateTransport;
        }));
    ...
    describe("Account Management", () => {
        ...
        it("should get Bitcoin accounts", () => __awaiter(void 0, void 0, void 0, function* () {
            var _a;
            ...
            const accounts = yield ledgerProvider.getAccounts(types_1.ChainId.BITCOIN);
            ...
            expect((_a = accounts[0].metadata) === null || _a === void 0 ? void 0 : _a.hardwareWallet).toBe(true);
        }));
        it("should get Stellar accounts", () => __awaiter(void 0, void 0, void 0, function* () {
            ...
            const accounts = yield ledgerProvider.getAccounts(types_1.ChainId.STELLAR);
            expect(accounts).toHaveLength(1);
        ...
        it("should get Starknet accounts", () => __awaiter(void 0, void 0, void 0, function* () {
            ledgerProvider.currentApp = {
                name: "Starknet",
                version: "1.0.0",
                flags: 0,
            };
            const accounts = yield ledgerProvider.getAccounts(types_1.ChainId.STARKNET);
            expect(accounts).toHaveLength(1);
        ...
        it("should cache accounts", () => __awaiter(void 0, void 0, void 0, function* () {
            ...
            const accounts1 = yield ledgerProvider.getAccounts(types_1.ChainId.BITCOIN);
            const accounts2 = yield ledgerProvider.getAccounts(types_1.ChainId.BITCOIN);
            expect(accounts1).toBe(accounts2); // Should return cached instance
        }));
        it("should throw error when device not connected", () => __awaiter(void 0, void 0, void 0, function* () {
            yield ledgerProvider.disconnect();
            yield expect(ledgerProvider.getAccounts(types_1.ChainId.BITCOIN)).rejects.toThrow(errors_1.ConnectionError);
        }));
        it("should throw error when wrong app is open", () => __awaiter(void 0, void 0, void 0, function* () {
            ledgerProvider.currentApp = {
                name: "Dashboard",
                version: "1.0.0",
                flags: 0,
            };
            yield expect(ledgerProvider.getAccounts(types_1.ChainId.BITCOIN)).rejects.toThrow(errors_1.HardwareWalletError);
        }));
    });
    describe("Transaction Signing", () => {
        ...
        it("should sign Bitcoin transactions", () => __awaiter(void 0, void 0, void 0, function* () {
            ...
            expect((_a = result.metadata) === null || _a === void 0 ? void 0 : _a.ledgerProvider).toBe(true);
        ...
        it("should throw error when device not connected", () => __awaiter(void 0, void 0, void 0, function* () {
            yield ledgerProvider.disconnect();
            yield expect(ledgerProvider.signTransaction(createBitcoinSigningRequest())).rejects.toThrow(errors_1.ConnectionError);
        }));
        it("should handle user rejection", () => __awaiter(void 0, void 0, void 0, function* () {
            ...
            yield expect(ledgerProvider.signTransaction(createBitcoinSigningRequest())).rejects.toThrow(errors_1.UserRejectedError);
            ledgerProvider.transport =
                originalTransport;
        }));
        it("should validate transaction format", () => __awaiter(void 0, void 0, void 0, function* () {
            ...
            yield expect(ledgerProvider.signTransaction(invalidRequest)).rejects.toThrow(errors_1.InvalidTransactionError);
        }));
        it("should handle device locked during signing", () => __awaiter(void 0, void 0, void 0, function* () {
            ledgerProvider.currentApp = {
                name: "Bitcoin",
                version: "1.0.0",
                flags: 0,
            ...
            yield expect(ledgerProvider.signTransaction(createBitcoinSigningRequest())).rejects.toThrow(errors_1.DeviceLockedError);
            ledgerProvider.transport =
                originalTransport;
        }));
        it("should handle device busy during signing", () => __awaiter(void 0, void 0, void 0, function* () {
            ledgerProvider.currentApp = {
                name: "Bitcoin",
                version: "1.0.0",
                flags: 0,
            ...
            yield expect(ledgerProvider.signTransaction(createBitcoinSigningRequest())).rejects.toThrow(errors_1.DeviceBusyError);
            ledgerProvider.transport =
                originalTransport;
        }));
    });
    describe("Capabilities", () => {
        it("should return correct capabilities", () => {
            ...
            expect((_a = capabilities.metadata) === null || _a === void 0 ? void 0 : _a.hardwareWallet).toBe(true);
            expect((_b = capabilities.metadata) === null || _b === void 0 ? void 0 : _b.requiresPhysicalConfirmation).toBe(true);
            expect((_c = capabilities.metadata) === null || _c === void 0 ? void 0 : _c.secureElement).toBe(true);
        });
    });
    describe("App Management", () => {
        ...
        it("should check if app is open", () => __awaiter(void 0, void 0, void 0, function* () {
            ledgerProvider.currentApp = {
                name: "Bitcoin",
                version: "1.0.0",
                flags: 0,
            };
            const isBitcoinOpen = yield ledgerProvider.isAppOpen(types_1.ChainId.BITCOIN);
            const isStellarOpen = yield ledgerProvider.isAppOpen(types_1.ChainId.STELLAR);
            expect(isBitcoinOpen).toBe(true);
            expect(isStellarOpen).toBe(false);
        }));
        it("should handle auto-open apps when enabled", () => __awaiter(void 0, void 0, void 0, function* () {
    ...
    describe("Error Handling", () => {
        it("should handle transport errors gracefully", () => __awaiter(void 0, void 0, void 0, function* () {
            yield ledgerProvider.connect();
            const originalTransport = ledgerProvider.transport;
            ledgerProvider.transport = {
                send: jest.fn().mockRejectedValue(new Error("Transport error")),
            };
            yield expect(ledgerProvider.getAccounts(types_1.ChainId.BITCOIN)).rejects.toThrow();
            ledgerProvider.transport =
                originalTransport;
        }));
        it("should handle unsupported chains", () => __awaiter(void 0, void 0, void 0, function* () {
            yield ledgerProvider.connect();
            yield expect(ledgerProvider.getAccounts("unsupported-chain")).rejects.toThrow(errors_1.UnsupportedChainError);
        }));
        it("should clear cache on disconnect", () => __awaiter(void 0, void 0, void 0, function* () {
            yield ledgerProvider.connect();
            ledgerProvider.currentApp = {
                name: "Bitcoin",
                version: "1.0.0",
            ...
            expect(ledgerProvider
                .cachedAccounts.size).toBe(1);
            yield ledgerProvider.disconnect();
            expect(ledgerProvider
                .cachedAccounts.size).toBe(0);
        }));
    });
    describe("Logging", () => {
        it("should log when debug logging is enabled", () => __awaiter(void 0, void 0, void 0, function* () {
            ...
            yield ledgerProvider.connect();
            expect(consoleSpy).toHaveBeenCalledWith(expect.stringContaining("[LedgerSignatureProvider]"), expect.anything());
