...
class StellarMetadataManager {
    constructor(config) {
        ...
        this.horizonUrl = (config === null || config === void 0 ? void 0 : config.horizonUrl) || "https://horizon.stellar.org";
        this.networkPassphrase =
            (config === null || config === void 0 ? void 0 : config.networkPassphrase) || stellar_sdk_1.Networks.PUBLIC_NETWORK_PASSPHRASE;
        this.baseFee = (config === null || config === void 0 ? void 0 : config.baseFee) || stellar_sdk_1.BASE_FEE;
    ...
    prepareSetMetadata(params) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (!/^[a-zA-Z0-9_-]{1,128}$/.test(params.key)) {
                throw new Error("Key must be alphanumeric with underscores/hyphens, max 128 chars");
            }
            ...
            try {
                ...
                const account = yield this.server.accounts().accountId(params.accountId).call();
                const stellarAccount = new stellar_sdk_1.Account(params.accountId, String(account.sequence));
                ...
                if (payload.length <= 64) {
                    ...
                    builder.addOperation(stellar_sdk_1.Operation.manageData({
                        name: dataKey,
                        value: payload,
                    }));
                }
    ...
    getMetadata(params) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                const datum = (_a = account.data_attr) === null || _a === void 0 ? void 0 : _a[datumKey];
                if (!datum) {
                    return null;
                }
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                if (cached && cached.length > 0) {
                    return {
                        accountId,
                        metadata: cached.filter((e) => !e.expiresAt || e.expiresAt > Math.floor(Date.now() / 1000)),
                        total: cached.length,
                        hasMore: false,
                    };
                }
                // Fetch from Horizon
                const account = yield this.server.accounts().accountId(accountId).call();
                const dataAttr = account.data_attr || {};
                const metadata = [];
                for (const [key, value] of Object.entries(dataAttr)) {
                    if (key.startsWith("md:") && !key.includes(":")) {
                        try {
                            const decodedValue = Buffer.from(String(value), "base64").toString("utf-8");
    ...
    prepareDeleteMetadata(accountId, key) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                const account = yield this.server.accounts().accountId(accountId).call();
                const stellarAccount = new stellar_sdk_1.Account(accountId, String(account.sequence));
