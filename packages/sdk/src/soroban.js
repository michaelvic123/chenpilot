...
function getExecutionLogs(params_1) {
    return __awaiter(this, arguments, void 0, function* (params, fetcher = globalThis.fetch) {
        var _a, _b, _c, _d;
        ...
        const raw = yield fetchRpc(rpcUrl, "getTransaction", { hash: params.txHash }, fetcher);
        ...
        return {
            ...
            returnValue: (_c = raw.returnValue) !== null && _c !== void 0 ? _c : null,
            events: formatEvents((_d = raw.events) !== null && _d !== void 0 ? _d : []),
            errorMessage: status === "FAILED" ? `Transaction failed: ${params.txHash}` : null,
        };
    });
}
/**
...
class SorobanBatchBuilder {
     ...
     */
    execute() {
        return __awaiter(this, arguments, void 0, function* (fetcher = globalThis.fetch) {
            ...
            try {
                ...
                return results.map((result, index) => {
                    ...
                    return {
                        ...
                        returnValue: (_c = raw.returnValue) !== null && _c !== void 0 ? _c : null,
                        events: formatEvents((_d = raw.events) !== null && _d !== void 0 ? _d : []),
                        errorMessage: status === "FAILED" ? `Transaction failed: ${txHash}` : null,
                    };
                });
            }
            catch (error) {
