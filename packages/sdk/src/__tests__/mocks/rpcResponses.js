...
exports.MockRpcClient = exports.mockTimeoutError = exports.mockNetworkError = exports.mockRpcErrorResponse = exports.mockComplexEventTransaction = exports.mockFailedTransaction = exports.mockMultiEventTransaction = exports.mockBurnTransaction = exports.mockMintTransaction = exports.mockTransferTransaction = exports.mockEmptyLedgerResponse = exports.mockLedgerResponse = void 0;
...
class MockRpcClient {
    constructor() {
        ...
        this.transactions.set(exports.mockTransferTransaction.hash, exports.mockTransferTransaction);
        this.transactions.set(exports.mockMintTransaction.hash, exports.mockMintTransaction);
        this.transactions.set(exports.mockBurnTransaction.hash, exports.mockBurnTransaction);
    }
    getLedger(sequence) {
