...
describe("Network Status API", () => {
    ...
    describe("checkNetworkHealth", () => {
        it("should return healthy status when RPC responds successfully", () => __awaiter(void 0, void 0, void 0, function* () {
            ...
            const health = yield (0, networkStatus_1.checkNetworkHealth)({ network: "testnet" });
            expect(health.isHealthy).toBe(true);
            expect(health.latestLedger).toBe(12345);
            expect(health.responseTimeMs).toBeGreaterThanOrEqual(0);
            expect(health.error).toBeUndefined();
        }));
        it("should return unhealthy status on HTTP error", () => __awaiter(void 0, void 0, void 0, function* () {
            global.fetch.mockResolvedValueOnce({
                ok: false,
                status: 503,
        ...
        it("should return unhealthy status on RPC error", () => __awaiter(void 0, void 0, void 0, function* () {
            global.fetch.mockResolvedValueOnce({
                ok: true,
                json: () => __awaiter(void 0, void 0, void 0, function* () {
                    return ({
        ...
        it("should use custom RPC URL when provided", () => __awaiter(void 0, void 0, void 0, function* () {
            ...
            expect(global.fetch).toHaveBeenCalledWith(customUrl, expect.objectContaining({
                method: "POST",
            }));
        }));
        it("should work with mainnet", () => __awaiter(void 0, void 0, void 0, function* () {
            global.fetch.mockResolvedValueOnce({
                ok: true,
                json: () => __awaiter(void 0, void 0, void 0, function* () {
                    return ({
            ...
            const health = yield (0, networkStatus_1.checkNetworkHealth)({ network: "mainnet" });
            expect(health.isHealthy).toBe(true);
            expect(health.latestLedger).toBe(54321);
            expect(global.fetch).toHaveBeenCalledWith("https://soroban-mainnet.stellar.org", expect.any(Object));
        }));
    });
    describe("checkLedgerLatency", () => {
        it("should return normal latency when ledger is recent", () => __awaiter(void 0, void 0, void 0, function* () {
            ...
            const latency = yield (0, networkStatus_1.checkLedgerLatency)({ network: "testnet" });
        ...
        it("should return abnormal latency when ledger is old", () => __awaiter(void 0, void 0, void 0, function* () {
            const currentTime = Math.floor(Date.now() / 1000);
        ...
        it("should throw on HTTP error", () => __awaiter(void 0, void 0, void 0, function* () {
            ...
            yield expect((0, networkStatus_1.checkLedgerLatency)({ network: "testnet" })).rejects.toThrow("Failed to fetch ledger");
        }));
        it("should throw on RPC error", () => __awaiter(void 0, void 0, void 0, function* () {
            global.fetch.mockResolvedValueOnce({
                ok: true,
                json: () => __awaiter(void 0, void 0, void 0, function* () {
                    return ({
            ...
            yield expect((0, networkStatus_1.checkLedgerLatency)({ network: "testnet" })).rejects.toThrow("Method not found");
        }));
    });
    describe("getProtocolVersion", () => {
        it("should return protocol version from Horizon", () => __awaiter(void 0, void 0, void 0, function* () {
            global.fetch.mockResolvedValueOnce({
                ok: true,
                json: () => __awaiter(void 0, void 0, void 0, function* () {
                    return ({
            ...
            const protocol = yield (0, networkStatus_1.getProtocolVersion)({ network: "testnet" });
            expect(protocol.version).toBe(20);
            expect(protocol.coreVersion).toBe("stellar-core 20.0.0");
            expect(protocol.networkPassphrase).toBe("Test SDF Network ; September 2015");
        }));
        it("should use custom Horizon URL when provided", () => __awaiter(void 0, void 0, void 0, function* () {
        ...
        it("should throw on HTTP error", () => __awaiter(void 0, void 0, void 0, function* () {
            ...
            yield expect((0, networkStatus_1.getProtocolVersion)({ network: "testnet" })).rejects.toThrow("Failed to fetch protocol version");
        }));
    ...
    describe("getNetworkStatus", () => {
        it("should return complete network status", () => __awaiter(void 0, void 0, void 0, function* () {
            const currentTime = Math.floor(Date.now() / 1000);
            ...
            const status = yield (0, networkStatus_1.getNetworkStatus)({ network: "testnet" });
        ...
        it("should work with mainnet configuration", () => __awaiter(void 0, void 0, void 0, function* () {
            const currentTime = Math.floor(Date.now() / 1000);
            global.fetch
            ...
            const status = yield (0, networkStatus_1.getNetworkStatus)({ network: "mainnet" });
            expect(status.health.isHealthy).toBe(true);
