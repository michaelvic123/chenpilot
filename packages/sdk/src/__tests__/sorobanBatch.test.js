...
describe("SorobanBatchBuilder", () => {
    describe("addTransaction", () => {
        ...
        it("should throw on invalid transaction hash", () => {
            const builder = new soroban_1.SorobanBatchBuilder("testnet");
            expect(() => builder.addTransaction("")).toThrow("Invalid transaction hash");
            expect(() => builder.addTransaction(null)).toThrow("Invalid transaction hash");
        });
    });
    ...
    describe("execute", () => {
        it("should return empty array for empty batch", () => __awaiter(void 0, void 0, void 0, function* () {
            const builder = new soroban_1.SorobanBatchBuilder("testnet");
            const results = yield builder.execute(() => __awaiter(void 0, void 0, void 0, function* () {
                throw new Error("Fetch should not be called");
            }));
            expect(results).toEqual([]);
        }));
        it("should execute batch request with single transaction", () => __awaiter(void 0, void 0, void 0, function* () {
            const builder = new soroban_1.SorobanBatchBuilder("testnet");
            builder.addTransaction("tx123");
            const mockFetch = () => __awaiter(void 0, void 0, void 0, function* () {
                return ({
                    ok: true,
        ...
        it("should execute batch request with multiple transactions", () => __awaiter(void 0, void 0, void 0, function* () {
            const builder = new soroban_1.SorobanBatchBuilder("testnet");
        ...
        it("should handle RPC errors in batch response", () => __awaiter(void 0, void 0, void 0, function* () {
            const builder = new soroban_1.SorobanBatchBuilder("testnet");
        ...
        it("should handle HTTP errors gracefully", () => __awaiter(void 0, void 0, void 0, function* () {
            const builder = new soroban_1.SorobanBatchBuilder("testnet");
            builder.addTransactions(["tx1", "tx2"]);
            const mockFetch = () => __awaiter(void 0, void 0, void 0, function* () {
        ...
        it("should maintain order of results", () => __awaiter(void 0, void 0, void 0, function* () {
            const builder = new soroban_1.SorobanBatchBuilder("testnet");
        ...
        it("should format events correctly from batch response", () => __awaiter(void 0, void 0, void 0, function* () {
            const builder = new soroban_1.SorobanBatchBuilder("testnet");
                        ...
                        return [
                            {
                                ...
                                result: {
                                    ...
                                    events: [
                                        {
                                            type: "contract",
                                            contractId: "CCJZ4IQSV5KFXV7W2O7ZMVXJ65I2LTGV7MNXNVXJ65I2LTGV7MNVXJ",
                                            topic: ["topic1", "topic2"],
                                            value: "eventData",
                                        },
                                    ],
        ...
        it("should use custom RPC URL when provided", () => __awaiter(void 0, void 0, void 0, function* () {
            let capturedUrl = "";
            const mockFetch = (url) => __awaiter(void 0, void 0, void 0, function* () {
                capturedUrl = url;
                return {
                    ok: true,
                    json: () => __awaiter(void 0, void 0, void 0, function* () {
        ...
        it("should use default RPC URL for network when not specified", () => __awaiter(void 0, void 0, void 0, function* () {
            let capturedUrl = "";
            const mockFetch = (url) => __awaiter(void 0, void 0, void 0, function* () {
                capturedUrl = url;
                return {
        ...
        it("should handle mainnet URL correctly", () => __awaiter(void 0, void 0, void 0, function* () {
            let capturedUrl = "";
            const mockFetch = (url) => __awaiter(void 0, void 0, void 0, function* () {
                capturedUrl = url;
                return {
        ...
        it("should handle multiple transactions with mixed statuses", () => __awaiter(void 0, void 0, void 0, function* () {
            const builder = new soroban_1.SorobanBatchBuilder("testnet");
        ...
        it("should handle responses with out-of-order IDs", () => __awaiter(void 0, void 0, void 0, function* () {
            const builder = new soroban_1.SorobanBatchBuilder("testnet");
            builder.addTransactions(["tx1", "tx2", "tx3"]);
            const mockFetch = () => __awaiter(void 0, void 0, void 0, function* () {
                return ({
        ...
        it("should reuse builder after clear", () => __awaiter(void 0, void 0, void 0, function* () {
            const builder = new soroban_1.SorobanBatchBuilder("testnet");
            builder.addTransactions(["tx1", "tx2"]);
            builder.clear();
