...
describe("Soroban RPC Client", () => {
    ...
    describe("RPC Configuration", () => {
        it("should use testnet RPC URL by default", () => {
            ...
            const subscription = new events_1.SorobanEventSubscription(config);
        ...
        it("should reject unknown network", () => {
            ...
            expect(() => new events_1.SorobanEventSubscription(config)).toThrow("Unknown network: invalid");
        });
    });
    describe("Event Subscription Lifecycle", () => {
        ...
        beforeEach(() => {
            ...
            subscription = new events_1.SorobanEventSubscription(config);
        });
        ...
        it("should activate on subscribe", () => __awaiter(void 0, void 0, void 0, function* () {
            yield subscription.subscribe();
            expect(subscription.isActive()).toBe(true);
        }));
        it("should deactivate on unsubscribe", () => __awaiter(void 0, void 0, void 0, function* () {
            yield subscription.subscribe();
            yield subscription.unsubscribe();
            expect(subscription.isActive()).toBe(false);
        }));
        it("should handle multiple subscribe calls", () => __awaiter(void 0, void 0, void 0, function* () {
            yield subscription.subscribe();
            yield subscription.subscribe();
            expect(subscription.isActive()).toBe(true);
        }));
        it("should handle multiple unsubscribe calls", () => __awaiter(void 0, void 0, void 0, function* () {
            yield subscription.subscribe();
            yield subscription.unsubscribe();
            yield subscription.unsubscribe();
            expect(subscription.isActive()).toBe(false);
    ...
    describe("Ledger Tracking", () => {
        ...
        it("should track last ledger after subscription", () => __awaiter(void 0, void 0, void 0, function* () {
            yield subscription.subscribe();
    ...
    describe("Contract ID Validation", () => {
        it("should require at least one contract ID", () => {
            ...
            expect(() => new events_1.SorobanEventSubscription(config)).toThrow("At least one contractId is required");
        });
    ...
    describe("Polling Configuration", () => {
        ...
        it("should poll at specified interval", () => __awaiter(void 0, void 0, void 0, function* () {
            const config = {
                network: "testnet",
                contractIds: ["CABC123"],
                pollingIntervalMs: 1000,
...
describe("parseEvent", () => {
    describe("Topic Parsing", () => {
        it("should parse string topics", () => {
            ...
            const result = (0, events_1.parseEvent)(raw, "CABC123", "tx_hash_123", 1000000, 1234567890);
        ...
        it("should stringify non-string topics", () => {
            ...
            const result = (0, events_1.parseEvent)(raw, "CABC123", "tx_hash_456", 1000001, 1234567891);
        ...
        it("should handle empty topics", () => {
            ...
            const result = (0, events_1.parseEvent)(raw, "CABC123", "tx_hash_789", 1000002, 1234567892);
            expect(result.topics).toEqual([]);
        });
        it("should handle missing topics", () => {
            ...
            const result = (0, events_1.parseEvent)(raw, "CABC123", "tx_hash_999", 1000003, 1234567893);
            expect(result.topics).toEqual([]);
        });
    });
    describe("Data Parsing", () => {
        it("should parse object data", () => {
            ...
            const result = (0, events_1.parseEvent)(raw, "CABC123", "tx_hash", 1000000, 1234567890);
    ...
    describe("Metadata Preservation", () => {
        it("should preserve transaction hash", () => {
            ...
            const result = (0, events_1.parseEvent)(raw, "CABC123", "tx_abc_123", 1000000, 1234567890);
            expect(result.transactionHash).toBe("tx_abc_123");
        });
        it("should preserve contract ID", () => {
            const raw = { topic: ["event"], value: "data" };
            const result = (0, events_1.parseEvent)(raw, "CTEST_CONTRACT", "tx_hash", 1000000, 1234567890);
            expect(result.contractId).toBe("CTEST_CONTRACT");
        });
        it("should preserve ledger sequence", () => {
            const raw = { topic: ["event"], value: "data" };
            const result = (0, events_1.parseEvent)(raw, "CABC123", "tx_hash", 2500000, 1234567890);
            expect(result.ledger).toBe(2500000);
        });
        it("should preserve timestamp", () => {
            const raw = { topic: ["event"], value: "data" };
            const result = (0, events_1.parseEvent)(raw, "CABC123", "tx_hash", 1000000, 1700000000);
        ...
        it("should create complete event object", () => {
            ...
            const result = (0, events_1.parseEvent)(raw, "CTEST", "tx_mint_123", 2000000, 1700000000);
...
describe("subscribeToEvents", () => {
    ...
    it("should create and start subscription", () => __awaiter(void 0, void 0, void 0, function* () {
        const config = {
            network: "testnet",
            contractIds: ["CABC123"],
        };
        const subscription = yield (0, events_1.subscribeToEvents)(config);
        expect(subscription).toBeDefined();
        expect(subscription.isActive()).toBe(true);
        yield subscription.unsubscribe();
    }));
    it("should return EventSubscription interface", () => __awaiter(void 0, void 0, void 0, function* () {
        const config = {
            network: "testnet",
            contractIds: ["CABC123"],
        };
    ...
    it("should start polling immediately", () => __awaiter(void 0, void 0, void 0, function* () {
        const config = {
            network: "testnet",
            contractIds: ["CABC123"],
            pollingIntervalMs: 1000,
