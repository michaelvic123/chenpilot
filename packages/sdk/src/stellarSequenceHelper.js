...
class StellarSequenceHelper {
    ...
    getNextSequence(accountId) {
        return __awaiter(this, void 0, void 0, function* () {
            return this.sequenceManager.getNextSequence(accountId, () => __awaiter(this, void 0, void 0, function* () {
    ...
    createManagedAccount(accountId, AccountClass) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            yield this.sequenceManager.reserveSequence(accountId, sequenceInfo.next, { timestamp: Date.now() });
    ...
    buildManagedTransaction(accountId, AccountClass, buildFn) {
        return __awaiter(this, void 0, void 0, function* () {
            const { account, sequenceInfo } = yield this.createManagedAccount(accountId, AccountClass);
            ...
            return {
                ...
                sequence,
                sequenceInfo,
                markSubmitted: (hash) => __awaiter(this, void 0, void 0, function* () {
                    yield this.sequenceManager.markSubmitted(accountId, sequence, hash);
                }),
                markConfirmed: () => __awaiter(this, void 0, void 0, function* () {
                    yield this.sequenceManager.markConfirmed(accountId, sequence);
                }),
                markFailed: () => __awaiter(this, void 0, void 0, function* () {
    ...
    submitManagedTransaction(accountId, AccountClass, buildFn, submitFn) {
        return __awaiter(this, void 0, void 0, function* () {
            const managed = yield this.buildManagedTransaction(accountId, AccountClass, buildFn);
            try {
                const result = yield submitFn(managed.transaction);
                // Extract hash if available
                const hash = typeof result === "object" && result !== null && "hash" in result
                    ? String(result.hash)
                    : undefined;
                if (hash) {
    ...
    refreshSequence(accountId) {
        return __awaiter(this, void 0, void 0, function* () {
            return this.sequenceManager.refreshSequence(accountId, () => __awaiter(this, void 0, void 0, function* () {
                const account = yield this.horizonServer.loadAccount(accountId);
                return account.sequenceNumber();
            }));
        });
