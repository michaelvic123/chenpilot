...
class SequenceManager {
    constructor(config = {}) {
        ...
        this.config = {
            ...
            maxPendingTransactions: (_b = config.maxPendingTransactions) !== null && _b !== void 0 ? _b : 100,
            autoRefresh: (_c = config.autoRefresh) !== null && _c !== void 0 ? _c : true,
            refreshInterval: (_d = config.refreshInterval) !== null && _d !== void 0 ? _d : 10000,
        };
    }
    /**
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                if (accountPending.size >= this.config.maxPendingTransactions) {
                    throw new Error(`Maximum pending transactions (${this.config.maxPendingTransactions}) reached for account ${accountId}`);
                }
                const transaction = {
                    sequence,
                    createdAt: Date.now(),
    ...
    markSubmitted(accountId, sequence, hash) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                const transaction = accountPending === null || accountPending === void 0 ? void 0 : accountPending.get(sequence);
                if (transaction) {
    ...
    getPendingTransactions(accountId) {
        ...
        return Array.from(accountPending.values()).map((tx) => (Object.assign({}, tx)));
    }
    /**
    ...
    refreshSequence(accountId, fetchSequence) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                const currentSeq = yield fetchSequence();
                const accountPending = this.pending.get(accountId);
                const pendingCount = (accountPending === null || accountPending === void 0 ? void 0 : accountPending.size) || 0;
     ...
     */
    getStats() {
        const accountStats = Array.from(this.sequences.entries()).map(([accountId, info]) => ({
            accountId,
            pendingCount: info.pendingCount,
            lastFetched: info.lastFetched,
            cacheAge: Date.now() - info.lastFetched,
        }));
        const totalPending = accountStats.reduce((sum, stat) => sum + stat.pendingCount, 0);
        return {
