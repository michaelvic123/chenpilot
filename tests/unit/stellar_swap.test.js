...
require("../stellar.mock"); // Use ../ to go up to the tests/ directory
const StellarSdk = __importStar(require("@stellar/stellar-sdk"));
describe("Stellar Swap Logic", () => {
    it("should find a path and build a swap transaction", () => __awaiter(void 0, void 0, void 0, function* () {
