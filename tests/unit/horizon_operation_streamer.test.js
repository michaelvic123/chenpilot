...
describe("HorizonOperationStreamerService", () => {
    ...
    it("emits a large-operation alert for qualifying payments", () => {
        const service = new horizonOperationStreamer_service_1.HorizonOperationStreamerService({
            server,
            enabled: true,
            minAmount: 1000,
            reconnectDelayMs: 50,
        ...
        service.start();
        onmessageHandler === null || onmessageHandler === void 0 ? void 0 : onmessageHandler({
            id: "op-1",
            type: "payment",
            amount: "1500.0000000",
            asset_type: "native",
    ...
    it("reconnects after stream errors", () => {
        ...
        onerrorHandler === null || onerrorHandler === void 0 ? void 0 : onerrorHandler(new Error("stream failed"));
    ...
    it("can unsubscribe listener and stop cleanly", () => {
        ...
        expect(horizonOperationStreamer_service_1.LARGE_OPERATION_ALERT_EVENT).toBe("stellar.large_operation");
    });
});
