...
const horizonProxy_routes_1 = __importDefault(require("../../src/Gateway/horizonProxy.routes"));
describe("Horizon Proxy Routes", () => {
    ...
    it("returns 401 when access token is missing", () => __awaiter(void 0, void 0, void 0, function* () {
    ...
    it("returns proxied data for authenticated requests", () => __awaiter(void 0, void 0, void 0, function* () {
        ...
        expect(mockProxyGet).toHaveBeenCalledWith("/accounts/GABCDEFGHIJKLMNOPQRSTUVWX1234567890ABCDEF", { limit: "20" });
    }));
    it("maps HorizonProxyError status codes", () => __awaiter(void 0, void 0, void 0, function* () {
        mockProxyGet.mockRejectedValue(new MockHorizonProxyError("Requested Horizon path is not allowlisted", 403));
        const response = yield (0, supertest_1.default)(app)
            .get("/horizon/proxy")
            .set("Authorization", "Bearer valid-token")
