...
describe("XDR Envelope Builder - Complex Multi-Operation Transactions", () => {
    ...
    describe("Complex Multi-Operation Scenarios", () => {
        ...
        it("should build XDR envelope for atomic swap with multiple assets", () => {
            ...
            const usdcAsset = new StellarSdk.Asset("USDC", "GA5ZSEJYB37JRC5AVCIA5MOP4RHTM335X2KGX3IHOJAPP5RE34K4KZVN");
            const usdtAsset = new StellarSdk.Asset("USDT", "GCQTGZQQ5G4PTM2GL7CDIFKUBIPEC52BROAQIAPW53XBRJVN6ZJVTG6V");
            const transaction = new StellarSdk.TransactionBuilder(sourceAccount, {
                fee: StellarSdk.BASE_FEE,
                networkPassphrase,
            })
        ...
        it("should build XDR envelope for liquidity pool operations", () => {
            const usdcAsset = new StellarSdk.Asset("USDC", "GA5ZSEJYB37JRC5AVCIA5MOP4RHTM335X2KGX3IHOJAPP5RE34K4KZVN");
            const liquidityPoolId = StellarSdk.getLiquidityPoolId("constant_product", {
            ...
            const transaction = new StellarSdk.TransactionBuilder(sourceAccount, {
                ...
                .addOperation(StellarSdk.Operation.changeTrust({
                asset: new StellarSdk.LiquidityPoolAsset(StellarSdk.Asset.native(), usdcAsset, StellarSdk.LiquidityPoolFeeV18),
                limit: "1000",
            }))
        ...
        it("should build XDR envelope with claimable balance creation and claim", () => {
            ...
            const transaction = new StellarSdk.TransactionBuilder(sourceAccount, {
                ...
                claimants: [
                    ...
                    new StellarSdk.Claimant(claimant2, StellarSdk.Claimant.predicateBeforeRelativeTime("3600")),
                ],
            }))
                .setTimeout(30)
                .build();
    ...
    describe("XDR Envelope Network Compatibility", () => {
        it("should build XDR envelope for testnet", () => {
            ...
            const xdr = transaction.toXDR();
            expect(xdr).toBeDefined();
            const reconstructed = new StellarSdk.Transaction(xdr, StellarSdk.Networks.TESTNET);
        ...
        it("should build XDR envelope for mainnet", () => {
            ...
            const xdr = transaction.toXDR();
            expect(xdr).toBeDefined();
            const reconstructed = new StellarSdk.Transaction(xdr, StellarSdk.Networks.PUBLIC);
