...
const DataExportService_1 = require("../../src/services/DataExportService");
const user_entity_1 = require("../../src/Auth/user.entity");
const contact_entity_1 = require("../../src/Contacts/contact.entity");
const refreshToken_entity_1 = require("../../src/Auth/refreshToken.entity");
...
describe("DataExportService", () => {
    ...
    beforeEach(() => {
        ...
        Datasource_1.default.getRepository.mockImplementation((entity) => {
            if (entity === user_entity_1.User)
                return mockUserRepository;
            if (entity === contact_entity_1.Contact)
                return mockContactRepository;
            if (entity === refreshToken_entity_1.RefreshToken)
                return mockRefreshTokenRepository;
            return null;
        });
        dataExportService = new DataExportService_1.DataExportService();
    });
    afterEach(() => {
        jest.clearAllMocks();
    });
    describe("exportUserData", () => {
        it("should export complete user profile data", () => __awaiter(void 0, void 0, void 0, function* () {
            const mockUser = {
                id: "user-123",
                name: "testuser",
            ...
            memory_1.memoryStore.get.mockReturnValue(mockConversationHistory);
            const result = yield dataExportService.exportUserData("user-123");
        ...
        it("should handle user with no contacts", () => __awaiter(void 0, void 0, void 0, function* () {
            const mockUser = {
                id: "user-123",
                name: "testuser",
                address: "GTEST123",
            ...
            memory_1.memoryStore.get.mockReturnValue([]);
            const result = yield dataExportService.exportUserData("user-123");
        ...
        it("should throw error when user not found", () => __awaiter(void 0, void 0, void 0, function* () {
            ...
            yield expect(dataExportService.exportUserData("nonexistent-user")).rejects.toThrow("User not found");
        }));
        it("should calculate account age correctly", () => __awaiter(void 0, void 0, void 0, function* () {
            const mockUser = {
                id: "user-123",
                name: "testuser",
                address: "GTEST123",
        ...
        it("should sanitize sensitive data (no private keys)", () => __awaiter(void 0, void 0, void 0, function* () {
            const mockUser = {
                id: "user-123",
                name: "testuser",
                address: "GTEST123",
        ...
        it("should include session revocation details", () => __awaiter(void 0, void 0, void 0, function* () {
            const mockUser = {
                id: "user-123",
                name: "testuser",
                address: "GTEST123",
    ...
    describe("exportUserDataAsJSON", () => {
        it("should return formatted JSON string", () => __awaiter(void 0, void 0, void 0, function* () {
            const mockUser = {
                id: "user-123",
                name: "testuser",
                address: "GTEST123",
            ...
            mockRefreshTokenRepository.find.mockResolvedValue([]);
            memory_1.memoryStore.get.mockReturnValue([]);
            const jsonString = yield dataExportService.exportUserDataAsJSON("user-123");
        ...
        it("should format JSON with proper indentation", () => __awaiter(void 0, void 0, void 0, function* () {
            const mockUser = {
                id: "user-123",
                name: "testuser",
                address: "GTEST123",
    ...
    describe("exportUserDataAsBuffer", () => {
        it("should return Buffer with UTF-8 encoding", () => __awaiter(void 0, void 0, void 0, function* () {
            const mockUser = {
                id: "user-123",
                name: "testuser",
                address: "GTEST123",
            ...
            mockRefreshTokenRepository.find.mockResolvedValue([]);
            memory_1.memoryStore.get.mockReturnValue([]);
            const buffer = yield dataExportService.exportUserDataAsBuffer("user-123");
    ...
    describe("Data Integrity", () => {
        it("should preserve ISO date format in export", () => __awaiter(void 0, void 0, void 0, function* () {
        ...
        it("should handle large conversation history", () => __awaiter(void 0, void 0, void 0, function* () {
            const mockUser = {
                id: "user-123",
                name: "testuser",
                address: "GTEST123",
            ...
            mockContactRepository.find.mockResolvedValue([]);
            mockRefreshTokenRepository.find.mockResolvedValue([]);
            memory_1.memoryStore.get.mockReturnValue(largeHistory);
            const result = yield dataExportService.exportUserData("user-123");
