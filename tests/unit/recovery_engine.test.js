...
describe("RecoveryEngine (focused)", () => {
    ...
    it("retries mint and succeeds", () => __awaiter(void 0, void 0, void 0, function* () {
        const engine = (0, src_1.createRecoveryEngine)({
            maxRetries: 3,
            retryDelayMs: 1,
            retryHandler: {
                retryMint: () => __awaiter(void 0, void 0, void 0, function* () {
                    return ({
    ...
    it("exhausts retries then refunds lock", () => __awaiter(void 0, void 0, void 0, function* () {
        let attempts = 0;
        const engine = (0, src_1.createRecoveryEngine)({
            maxRetries: 1,
            retryDelayMs: 1,
            ...
            refundHandler: {
                refundLock: () => __awaiter(void 0, void 0, void 0, function* () {
                    return ({
    ...
    it("requires manual intervention when no handlers configured", () => __awaiter(void 0, void 0, void 0, function* () {
        const engine = (0, src_1.createRecoveryEngine)({ maxRetries: 1, retryDelayMs: 1 });
        const res = yield engine.cleanup(baseContext);
