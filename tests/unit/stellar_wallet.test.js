...
describe("Stellar Wallet Operations", () => {
    ...
    it("should retrieve balances for a Stellar account", () => __awaiter(void 0, void 0, void 0, function* () {
        // Note: We use the .Horizon namespace to match the latest SDK structure
        const server = new StellarSdk.Horizon.Server("https://horizon-testnet.stellar.org");
        const account = yield server.loadAccount("GD77MOCKPUBLICKEY1234567890");
        expect(account.balances).toContainEqual(expect.objectContaining({
            asset_type: "native",
            balance: "100.0000",
        }));
