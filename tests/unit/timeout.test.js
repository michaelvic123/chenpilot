...
describe("Timeout Utility", () => {
    describe("withTimeout", () => {
        it("should resolve when promise completes within timeout", () => __awaiter(void 0, void 0, void 0, function* () {
        ...
        it("should reject with TimeoutError when promise exceeds timeout", () => __awaiter(void 0, void 0, void 0, function* () {
            const promise = new Promise((resolve) => setTimeout(resolve, 2000));
            yield expect((0, timeout_1.withTimeout)(promise, {
                timeoutMs: 100,
                operation: "slow_operation",
            })).rejects.toThrow(timeout_1.TimeoutError);
        }));
        it("should call onTimeout callback when timeout occurs", () => __awaiter(void 0, void 0, void 0, function* () {
        ...
        it("should include operation name in TimeoutError", () => __awaiter(void 0, void 0, void 0, function* () {
            const promise = new Promise((resolve) => setTimeout(resolve, 2000));
            try {
                yield (0, timeout_1.withTimeout)(promise, {
                    timeoutMs: 100,
        ...
        it("should handle promise rejection", () => __awaiter(void 0, void 0, void 0, function* () {
        ...
        it("should abort when signal is already aborted", () => __awaiter(void 0, void 0, void 0, function* () {
        ...
        it("should abort when signal is aborted during execution", () => __awaiter(void 0, void 0, void 0, function* () {
            const controller = new AbortController();
            const promise = new Promise((resolve) => setTimeout(resolve, 2000));
    ...
    describe("TimeoutManager", () => {
        ...
        it("should execute operation successfully", () => __awaiter(void 0, void 0, void 0, function* () {
            const promise = Promise.resolve("success");
        ...
        it("should track active operations", () => __awaiter(void 0, void 0, void 0, function* () {
        ...
        it("should abort specific operation", () => __awaiter(void 0, void 0, void 0, function* () {
            const promise = new Promise((resolve) => setTimeout(resolve, 2000));
            const execution = manager.execute("op1", promise, {
                timeoutMs: 5000,
                operation: "test_operation",
        ...
        it("should abort all operations", () => __awaiter(void 0, void 0, void 0, function* () {
        ...
        it("should handle multiple operations with same ID sequentially", () => __awaiter(void 0, void 0, void 0, function* () {
