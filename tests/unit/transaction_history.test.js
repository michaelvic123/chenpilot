...
describe("TransactionHistoryService", () => {
    ...
    describe("getTransactionHistory", () => {
        it("should return transaction history for a valid user", () => __awaiter(void 0, void 0, void 0, function* () {
            const mockUser = {
                id: "user1",
                name: "testuser",
        ...
        it("should throw error for non-existent user", () => __awaiter(void 0, void 0, void 0, function* () {
            ...
            yield expect(service.getTransactionHistory("nonexistent", {})).rejects.toThrow("User not found");
        }));
        ...
        it("should apply date range filter", () => __awaiter(void 0, void 0, void 0, function* () {
            const mockUser = {
                id: "user1",
                name: "testuser",
                address: "GD77MOCKPUBLICKEY1234567890",
        ...
        it("should throw error for limit > 100", () => __awaiter(void 0, void 0, void 0, function* () {
            const mockUser = {
                id: "user1",
                name: "testuser",
                address: "GD77MOCKPUBLICKEY1234567890",
            ...
            mockUserRepository.findOne.mockResolvedValue(mockUser);
            yield expect(service.getTransactionHistory("user1", { limit: 150 })).rejects.toThrow("Limit cannot exceed 100");
        }));
        it("should cache results for 30 seconds", () => __awaiter(void 0, void 0, void 0, function* () {
            const mockUser = {
                id: "user1",
                name: "testuser",
                address: "GD77MOCKPUBLICKEY1234567890",
