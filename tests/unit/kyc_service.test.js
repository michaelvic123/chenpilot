...
describe("KycProviderFactory", () => {
    ...
    it("throws when provider is not registered", () => {
        ...
        expect(() => factory.getProvider()).toThrow("KYC provider 'unknown' is not registered");
    });
...
describe("KycService", () => {
    ...
    it("submits verification through selected provider", () => __awaiter(void 0, void 0, void 0, function* () {
        const factory = new KycProviderFactory_1.KycProviderFactory("mock");
    ...
    it("retrieves verification status by provider reference id", () => __awaiter(void 0, void 0, void 0, function* () {
        const factory = new KycProviderFactory_1.KycProviderFactory("mock");
        factory.register(new mockKycProvider_1.MockKycProvider());
        const service = new KycService_1.KycService(factory);
        const created = yield service.submitVerification(baseRequest);
        const status = yield service.getVerificationStatus(created.providerReferenceId);
        expect(status).not.toBeNull();
        expect(status === null || status === void 0 ? void 0 : status.providerReferenceId).toBe(created.providerReferenceId);
        expect(status === null || status === void 0 ? void 0 : status.status).toBe("pending");
    }));
    it("supports provider-driven rejection outcomes", () => __awaiter(void 0, void 0, void 0, function* () {
        const factory = new KycProviderFactory_1.KycProviderFactory("mock");
        factory.register(new mockKycProvider_1.MockKycProvider());
        const service = new KycService_1.KycService(factory);
        const rejectedRequest = Object.assign(Object.assign({}, baseRequest), { person: Object.assign(Object.assign({}, baseRequest.person), { fullName: "Reject Candidate" }) });
        const result = yield service.submitVerification(rejectedRequest);
        expect(result.status).toBe("rejected");
        expect(result.reason).toContain("Mock provider");
    }));
    it("delegates health checks to provider", () => __awaiter(void 0, void 0, void 0, function* () {
