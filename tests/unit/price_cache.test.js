...
(0, globals_1.describe)("PriceCacheService", () => {
    ...
    (0, globals_1.describe)("setPrice and getPrice", () => {
        (0, globals_1.it)("should cache and retrieve a price", () => __awaiter(void 0, void 0, void 0, function* () {
            ...
            (0, globals_1.expect)(cached === null || cached === void 0 ? void 0 : cached.price).toBe(0.12);
            (0, globals_1.expect)(cached === null || cached === void 0 ? void 0 : cached.source).toBe("stellar_dex");
            (0, globals_1.expect)(cached === null || cached === void 0 ? void 0 : cached.timestamp).toBeLessThanOrEqual(Date.now());
        }));
        (0, globals_1.it)("should return null for non-existent price", () => __awaiter(void 0, void 0, void 0, function* () {
            const cached = yield cacheService.getPrice("XLM", "USDT");
            (0, globals_1.expect)(cached).toBeNull();
        }));
        (0, globals_1.it)("should handle case-insensitive asset symbols", () => __awaiter(void 0, void 0, void 0, function* () {
            yield cacheService.setPrice("xlm", "usdc", 0.12, "stellar_dex", 60);
            const cached = yield cacheService.getPrice("XLM", "USDC");
            (0, globals_1.expect)(cached).not.toBeNull();
            (0, globals_1.expect)(cached === null || cached === void 0 ? void 0 : cached.price).toBe(0.12);
        }));
        (0, globals_1.it)("should expire after TTL", () => __awaiter(void 0, void 0, void 0, function* () {
    ...
    (0, globals_1.describe)("getPrices", () => {
        (0, globals_1.it)("should retrieve multiple prices at once", () => __awaiter(void 0, void 0, void 0, function* () {
            var _a, _b, _c;
            yield cacheService.setPrice("XLM", "USDC", 0.12, "stellar_dex", 60);
            ...
            (0, globals_1.expect)((_a = results.get("XLM/USDC")) === null || _a === void 0 ? void 0 : _a.price).toBe(0.12);
            (0, globals_1.expect)((_b = results.get("XLM/USDT")) === null || _b === void 0 ? void 0 : _b.price).toBe(0.11);
            (0, globals_1.expect)((_c = results.get("USDC/USDT")) === null || _c === void 0 ? void 0 : _c.price).toBe(0.99);
        }));
        (0, globals_1.it)("should handle missing prices in batch", () => __awaiter(void 0, void 0, void 0, function* () {
            var _a;
            yield cacheService.setPrice("XLM", "USDC", 0.12, "stellar_dex", 60);
            const pairs = [
                { from: "XLM", to: "USDC" },
    ...
    (0, globals_1.describe)("invalidatePrice", () => {
        (0, globals_1.it)("should invalidate a cached price", () => __awaiter(void 0, void 0, void 0, function* () {
            yield cacheService.setPrice("XLM", "USDC", 0.12, "stellar_dex", 60);
    ...
    (0, globals_1.describe)("clearAll", () => {
        (0, globals_1.it)("should clear all cached prices", () => __awaiter(void 0, void 0, void 0, function* () {
            yield cacheService.setPrice("XLM", "USDC", 0.12, "stellar_dex", 60);
            yield cacheService.setPrice("XLM", "USDT", 0.11, "stellar_dex", 60);
            yield cacheService.clearAll();
    ...
    (0, globals_1.describe)("getStats", () => {
        (0, globals_1.it)("should return cache statistics", () => __awaiter(void 0, void 0, void 0, function* () {
            yield cacheService.setPrice("XLM", "USDC", 0.12, "stellar_dex", 60);
            yield cacheService.setPrice("XLM", "USDT", 0.11, "stellar_dex", 60);
    ...
    (0, globals_1.describe)("healthCheck", () => {
        (0, globals_1.it)("should return true when Redis is connected", () => __awaiter(void 0, void 0, void 0, function* () {
