...
(0, globals_1.describe)("JWT Refresh Token Rotation", () => {
    ...
    (0, globals_1.it)("should generate token pair", () => __awaiter(void 0, void 0, void 0, function* () {
        const tokens = yield jwtService.generateTokenPair(testUserId, "testuser_jwt");
    ...
    (0, globals_1.it)("should verify valid access token", () => __awaiter(void 0, void 0, void 0, function* () {
        const tokens = yield jwtService.generateTokenPair(testUserId, "testuser_jwt");
    ...
    (0, globals_1.it)("should rotate refresh token successfully", () => __awaiter(void 0, void 0, void 0, function* () {
        const tokens1 = yield jwtService.generateTokenPair(testUserId, "testuser_jwt");
        ...
        (0, globals_1.expect)(tokens2.refreshToken).not.toBe(tokens1.refreshToken);
    }));
    (0, globals_1.it)("should reject reused refresh token", () => __awaiter(void 0, void 0, void 0, function* () {
        const tokens1 = yield jwtService.generateTokenPair(testUserId, "testuser_jwt");
        // Use token once
        yield jwtService.rotateRefreshToken(tokens1.refreshToken);
        // Try to reuse the same token
        yield (0, globals_1.expect)(jwtService.rotateRefreshToken(tokens1.refreshToken)).rejects.toThrow("Token has been revoked");
    }));
    (0, globals_1.it)("should revoke specific token", () => __awaiter(void 0, void 0, void 0, function* () {
        const tokens = yield jwtService.generateTokenPair(testUserId, "testuser_jwt");
        yield jwtService.revokeToken(tokens.refreshToken, "Test revocation");
        yield (0, globals_1.expect)(jwtService.rotateRefreshToken(tokens.refreshToken)).rejects.toThrow("Token has been revoked");
    }));
    (0, globals_1.it)("should revoke all user tokens", () => __awaiter(void 0, void 0, void 0, function* () {
        const tokens1 = yield jwtService.generateTokenPair(testUserId, "testuser_jwt");
        const tokens2 = yield jwtService.generateTokenPair(testUserId, "testuser_jwt");
        yield jwtService.revokeAllUserTokens(testUserId, "Test logout all");
        yield (0, globals_1.expect)(jwtService.rotateRefreshToken(tokens1.refreshToken)).rejects.toThrow();
        yield (0, globals_1.expect)(jwtService.rotateRefreshToken(tokens2.refreshToken)).rejects.toThrow();
    }));
    (0, globals_1.it)("should list active user tokens", () => __awaiter(void 0, void 0, void 0, function* () {
        // Clean up first
    ...
    (0, globals_1.it)("should cleanup expired tokens", () => __awaiter(void 0, void 0, void 0, function* () {
