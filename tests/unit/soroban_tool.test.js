...
describe("SorobanTool wiring", () => {
    ...
    it("calls invokeContract with expected params", () => __awaiter(void 0, void 0, void 0, function* () {
    ...
    it("defaults network to testnet", () => __awaiter(void 0, void 0, void 0, function* () {
        mockInvoke.mockResolvedValue({
            network: "testnet",
            contractId: "CABC1234567890",
            method: "ping",
    ...
    it("returns error result when service throws", () => __awaiter(void 0, void 0, void 0, function* () {
