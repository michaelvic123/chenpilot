...
(0, globals_1.describe)("AgentPlanner", () => {
    ...
    (0, globals_1.describe)("createPlan", () => {
        (0, globals_1.it)("should create a plan for simple balance check", () => __awaiter(void 0, void 0, void 0, function* () {
            const context = {
                userId: "test-user",
        ...
        (0, globals_1.it)("should create a plan for token swap", () => __awaiter(void 0, void 0, void 0, function* () {
            const context = {
                userId: "test-user",
            ...
            const plan = yield planner.createPlan(context);
            (0, globals_1.expect)(plan.totalSteps).toBeGreaterThan(0);
            (0, globals_1.expect)(plan.steps.some((s) => s.action === "swap_tool")).toBe(true);
            (0, globals_1.expect)(plan.riskLevel).toMatch(/low|medium/);
        }));
        (0, globals_1.it)("should create a plan for portfolio liquidation", () => __awaiter(void 0, void 0, void 0, function* () {
            const context = {
                userId: "test-user",
            ...
            (0, globals_1.expect)(plan.steps.some((s) => s.action === "wallet_tool")).toBe(true);
            (0, globals_1.expect)(plan.steps.some((s) => s.action === "swap_tool")).toBe(true);
            (0, globals_1.expect)(plan.requiresApproval).toBe(true);
        }));
        (0, globals_1.it)("should create a plan for Soroban contract interaction", () => __awaiter(void 0, void 0, void 0, function* () {
            const context = {
                userId: "test-user",
            ...
            const plan = yield planner.createPlan(context);
            (0, globals_1.expect)(plan.totalSteps).toBeGreaterThan(0);
            (0, globals_1.expect)(plan.steps.some((s) => s.action === "soroban_invoke")).toBe(true);
            (0, globals_1.expect)(plan.steps[0].payload).toHaveProperty("contractId");
            (0, globals_1.expect)(plan.steps[0].payload).toHaveProperty("method", "stake");
        }));
        (0, globals_1.it)("should respect max steps constraint", () => __awaiter(void 0, void 0, void 0, function* () {
            const context = {
                userId: "test-user",
        ...
        (0, globals_1.it)("should assess risk level correctly", () => __awaiter(void 0, void 0, void 0, function* () {
            const context = {
                userId: "test-user",
                userInput: "Swap 100 XLM to USDC",
            };
        ...
        (0, globals_1.it)("should generate step descriptions", () => __awaiter(void 0, void 0, void 0, function* () {
            const context = {
                userId: "test-user",
        ...
        (0, globals_1.it)("should calculate step dependencies", () => __awaiter(void 0, void 0, void 0, function* () {
            const context = {
                userId: "test-user",
    ...
    (0, globals_1.describe)("validatePlan", () => {
        (0, globals_1.it)("should validate a correct plan", () => __awaiter(void 0, void 0, void 0, function* () {
            const context = {
                userId: "test-user",
                userInput: "Check my XLM balance",
            };
        ...
        (0, globals_1.it)("should reject plan with too many steps", () => __awaiter(void 0, void 0, void 0, function* () {
            const context = {
                userId: "test-user",
    ...
    (0, globals_1.describe)("optimizePlan", () => {
        (0, globals_1.it)("should remove duplicate balance checks", () => __awaiter(void 0, void 0, void 0, function* () {
            const context = {
                userId: "test-user",
            ...
            const balanceChecks = optimized.steps.filter((s) => s.action === "wallet_tool" &&
                s.payload.operation === "get_balance" &&
                s.payload.token === "XLM");
            (0, globals_1.expect)(balanceChecks.length).toBeLessThanOrEqual(1);
        }));
        (0, globals_1.it)("should renumber steps after optimization", () => __awaiter(void 0, void 0, void 0, function* () {
            const context = {
                userId: "test-user",
...
(0, globals_1.describe)("PlanExecutor", () => {
    ...
    (0, globals_1.describe)("executePlan", () => {
        (0, globals_1.it)("should execute a simple plan in dry-run mode", () => __awaiter(void 0, void 0, void 0, function* () {
            const context = {
                userId: "test-user",
                userInput: "Check my XLM balance",
            };
        ...
        (0, globals_1.it)("should track execution progress", () => __awaiter(void 0, void 0, void 0, function* () {
            const context = {
                userId: "test-user",
        ...
        (0, globals_1.it)("should stop on error when configured", () => __awaiter(void 0, void 0, void 0, function* () {
            const context = {
                userId: "test-user",
        ...
        (0, globals_1.it)("should respect timeout", () => __awaiter(void 0, void 0, void 0, function* () {
            const context = {
                userId: "test-user",
                userInput: "Check balance",
            };
        ...
        (0, globals_1.it)("should record step durations", () => __awaiter(void 0, void 0, void 0, function* () {
            const context = {
                userId: "test-user",
                userInput: "Check balance",
            };
    ...
    (0, globals_1.describe)("dependency handling", () => {
        (0, globals_1.it)("should execute steps with dependencies in order", () => __awaiter(void 0, void 0, void 0, function* () {
            const context = {
                userId: "test-user",
...
(0, globals_1.describe)("Integration: Planner + Executor", () => {
    ...
    (0, globals_1.it)("should handle complete workflow: plan creation to execution", () => __awaiter(void 0, void 0, void 0, function* () {
        const context = {
            userId: "test-user",
            userInput: "Swap 100 XLM to USDC",
        };
        ...
        // Optimize plan
        const optimized = planner.optimizePlan(plan);
        (0, globals_1.expect)(optimized.totalSteps).toBeLessThanOrEqual(plan.totalSteps);
    ...
    (0, globals_1.it)("should handle complex multi-step operation", () => __awaiter(void 0, void 0, void 0, function* () {
        const context = {
            userId: "test-user",
            userInput: "Liquidate half my portfolio into USDC",
            availableBalance: {
